...
I ran into a situation recently where upgrading a dependency highlighted the use of an algorithm that is no longer fit for purpose. Having looked up the algorithm, it was very rewarding to be able to explain to others some of the problems related to the algorithm in more depth because of the cryptopals challenges.
