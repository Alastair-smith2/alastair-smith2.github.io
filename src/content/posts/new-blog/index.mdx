...
1. <ArticleLink href="https://astro.build/" text="Astro" />, which provides a
   great developer experience for building content-focused websites. It
   generates static HTML by default with zero JavaScript shipped to the browser
   unless you explicitly add interactive components.
2. <ArticleLink href="https://tailwindcss.com/" text="Tailwind" />, I hadn't
   ...
   comment about how much they like Tailwind and now see why.
3. <ArticleLink href="https://playwright.dev/" text="Playwright" />, I'd
   ...
   good things and given the recent announcement of <ArticleLink
     ...
     text="page.getBy\*"
   />
   I thought I'd give it a whirl. Getting
   <ArticleLink
     href="https://playwright.dev/docs/accessibility-testing"
     text="axe-core"
   /> integrated for _some_ automated accessibility testing was straightforward
   as well.
...
We'll see what else pops up in this space.
