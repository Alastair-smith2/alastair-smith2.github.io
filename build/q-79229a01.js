import{d as a,z as h,c as e}from"./q-b81c8d5c.js";import{A as n,P as l}from"./q-3e8a2ef1.js";const d=[{text:"A new blog",id:"a-new-blog",level:1},{text:"So why a blog?",id:"so-why-a-blog",level:2},{text:"What is this built with?",id:"what-is-this-built-with",level:2}],w={title:"New blog",meta:[{name:"author",content:"Alastair Smith"},{name:"description",content:"Why a new blog?"},{property:"og:title",content:"New blog"},{property:"og:description",content:"Why a new blog?"}],styles:[],links:[],frontmatter:{Date:"31/03/2022"}},g={title:"New blog",author:"Alastair Smith",description:"Why a new blog?",Date:"31/03/2022",og:[{title:"New blog",description:!0}]};function o(i){const t=Object.assign({h1:"h1",a:"a",span:"span",ol:"ol",li:"li",h2:"h2",p:"p",em:"em"},i.components);return e(l,{children:[e(t.h1,{id:"a-new-blog",children:[e(t.a,{"aria-hidden":"true",tabindex:"-1",href:"#a-new-blog",children:e(t.span,{class:"icon icon-link"})}),"A new blog"]}),e(t.ol,{children:[`
...
`,e(t.li,{children:[e(n,{href:"https://qwik.builder.io/",text:"Qwik"}),", specifically ",e(n,{href:"https://www.builder.io/blog/resumability-from-ground-up",text:"resumability"})," caught my attention and I'm intrigued to see how Qwik develops. A ",e(n,{href:"https://www.builder.io/blog/qwik-rc-milestone",text:"1.0 RC"}),` was announced yesterday but time will tell as there's a lot going on in
...
`,e(t.li,{children:[e(n,{href:"https://tailwindcss.com/",text:"Tailwind"}),`, I hadn't
...
`,e(t.li,{children:[e(n,{href:"https://playwright.dev/",text:"Playwright"}),`, I'd
normally default to cypress for E2E testing in JS / TS but again had heard
good things and given the recent announcement of `,e(n,{href:"https://github.com/microsoft/playwright/releases/tag/v1.27.0",text:"page.getBy\\*"}),`
I thought I'd give a whirl. Getting
`,e(n,{href:"https://playwright.dev/docs/accessibility-testing",text:"axe-core"})," integrated for ",e(t.em,{children:"some"}),` automated accessibility testing was straight forward
as well.`]}),`
`,e(t.li,{children:[e(n,{href:"https://pages.github.com/",text:"Github pages"}),`, is a
convenient way to host for free.`]}),`
`]}),e(t.p,{children:["It's been nice to be able to leverage ",e(n,{href:"https://github.com/features/actions",text:"Github actions"})," to automate the build and deploy process."]}),e(t.p,{children:"We'll see what else pops up on this space."})]})}function r(i={}){const{wrapper:t}=i.components||{};return t?e(t,Object.assign({},i,{children:e(o,i)})):o(i)}const p=()=>a(h,{children:a(r,{},3,null)},3,"VBvkRbcQ");export{p as default,g as frontmatter,w as head,d as headings};
